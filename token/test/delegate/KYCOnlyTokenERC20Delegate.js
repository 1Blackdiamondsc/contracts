...
contract('KYCOnlyTokenERC20Delegate', function (accounts) {
  let core, coreAsDelegate, delegate, token, userRegistry;
  ...
  beforeEach(async function () {
    delegate = await KYCOnlyTokenERC20Delegate.new();
    ...
    coreAsDelegate = await KYCOnlyTokenERC20Delegate.at(core.address);
