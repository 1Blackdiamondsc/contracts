...
contract('BaseTokenERC20Delegate', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    hre.tracer.nameTags[accounts[0]] = 'SysOp';
    hre.tracer.nameTags[core.address] = 'Core';
    hre.tracer.nameTags[delegate.address] = 'Delegate';
  });
  ...
  describe('With a token defined', async function () {
    ...
    beforeEach(async function () {
      ...
      hre.tracer.nameTags[token.address] = 'Token';
    });
